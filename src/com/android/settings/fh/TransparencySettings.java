...
public class TransparencySettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
            ...
            addPreferencesFromResource(R.xml.fh_transparency);
            ...
            mVolumeDialogStrokeThickness =
                    (CustomSeekBarPreference) prefSet.findPreference(PREF_VOLUME_DIALOG_STROKE_THICKNESS);
            ...
            mVolumeDialogCornerRadius =
                    (CustomSeekBarPreference) prefSet.findPreference(PREF_VOLUME_DIALOG_CORNER_RADIUS);
            ...
            mVolumeDialogDashWidth =
                    (CustomSeekBarPreference) prefSet.findPreference(PREF_VOLUME_DIALOG_STROKE_DASH_WIDTH);
            ...
            mVolumeDialogDashGap =
                    (CustomSeekBarPreference) prefSet.findPreference(PREF_VOLUME_DIALOG_STROKE_DASH_GAP);
            ...
            // QS stroke thickness
            mQSStrokeThickness =
                    (CustomSeekBarPreference) prefSet.findPreference(PREF_QS_STROKE_THICKNESS);
            ...
            // QS corner radius
            mQSCornerRadius =
                    (CustomSeekBarPreference) prefSet.findPreference(PREF_QS_CORNER_RADIUS);
            ...
            // QS dash width
            mQSDashWidth =
                    (CustomSeekBarPreference) prefSet.findPreference(PREF_QS_STROKE_DASH_WIDTH);
            ...
            // QS dash gap
            mQSDashGap =
                    (CustomSeekBarPreference) prefSet.findPreference(PREF_QS_STROKE_DASH_GAP);
